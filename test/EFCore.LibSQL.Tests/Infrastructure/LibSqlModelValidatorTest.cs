...
/// <inheritdoc/>
public class LibSqlModelValidatorTest : RelationalModelValidatorTest
{
    [ConditionalFact]
    ...
    public void Detects_schemas()
    {
        ...
        VerifyWarning(
            LibSqlResources.LogSchemaConfigured(new TestLogger<LibSqlLoggingDefinitions>()).GenerateMessage("Animal", "pet"),
            modelBuilder);
    }
    ...
    public void Detects_sequences()
    {
        ...
        VerifyWarning(
            LibSqlResources.LogSequenceConfigured(new TestLogger<LibSqlLoggingDefinitions>()).GenerateMessage("Fibonacci"),
            modelBuilder);
    }
    ...
    public void Detects_insert_stored_procedures()
    {
        ...
        VerifyError(LibSqlStrings.StoredProceduresNotSupported(nameof(Person)), modelBuilder);
    }
    ...
    public virtual void Detects_incompatible_sql_returning_clause_shared_table()
    {
        ...
        VerifyError(
            LibSqlStrings.IncompatibleSqlReturningClauseMismatch("Table", nameof(A), nameof(B), nameof(B), nameof(A)),
            modelBuilder);
    }
    ...
    public override void Passes_for_stored_procedure_without_parameter_for_insert_non_save_property()
    {
        ...
        Assert.Equal(LibSqlStrings.StoredProceduresNotSupported(nameof(Animal)), exception.Message);
    }
    ...
    public override void Passes_on_derived_entity_type_mapped_to_a_stored_procedure_in_TPT()
    {
        ...
        Assert.Equal(LibSqlStrings.StoredProceduresNotSupported(nameof(Cat)), exception.Message);
    }
    ...
    public override void Store_generated_in_composite_key()
    {
        ...
        VerifyWarning(
            LibSqlResources.LogCompositeKeyWithValueGeneration(
                new TestLogger<LibSqlLoggingDefinitions>()).GenerateMessage(nameof(CarbonComposite), "{'Id1', 'Id2'}"),
            modelBuilder);
    }
