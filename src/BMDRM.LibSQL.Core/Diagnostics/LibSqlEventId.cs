...
namespace Microsoft.EntityFrameworkCore.LibSql.Diagnostics;

/// <summary>
///     Event IDs for LibSql events that correspond to messages logged to an <see cref="ILogger" />
...
public static class LibSqlEventId
{
    ...
    /// <summary>
    ///     A schema was configured for an entity type, but LibSql does not support schemas.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    /// <summary>
    ///     A sequence was configured for an entity type, but LibSql does not support sequences.
    /// </summary>
    /// <remarks>
    ///     <para>
    ///         This event is in the <see cref="DbLoggerCategory.Model.Validation" /> category.
    ...
    /// <summary>
    ///     An entity type has composite key which is configured to use generated values. LibSql does not support generated values
    ///     on composite keys.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    /// <summary>
    ///     LibSql does not support schemas.
    /// </summary>
    /// <remarks>
    ///     This event is in the <see cref="DbLoggerCategory.Scaffolding" /> category.
    /// </remarks>
