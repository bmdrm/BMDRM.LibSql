...
namespace Microsoft.EntityFrameworkCore.LibSql.Scaffolding;
using System.Data;
...
public class LibSqlDatabaseModelFactory : DatabaseModelFactory
{
    ...
    public override DatabaseModel Create(string connectionString, DatabaseModelFactoryOptions options)
    {
        ...
        using var connection = new HttpDbConnection(connectionString, _httpClientFactory);
...
""";
        ...
        while (reader.Read())
        {
            ...
            var autoIncrement = 0;
            if (connection is HttpDbConnection httpDbCommand
