...
public class LibSqlStringAggregateMethodTranslator : IAggregateMethodCallTranslator
{
    ...
    {
        // Docs: https://LibSql.org/lang_aggfunc.html#group_concat
        ...
        // LibSql does not support input ordering on aggregate methods. Since ordering matters very much for translating, if the user
