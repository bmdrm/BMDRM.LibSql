...
/// <summary>
///     Contains extension methods on <see cref="DbFunctions" /> for the Microsoft.EntityFrameworkCore.LibSql provider.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    ///     Maps to the LibSql <c>glob</c> function which is similar to
    ...
    /// <summary>
    ///     Maps to the LibSql <c>hex</c> function which returns a hexadecimal string representing the specified value.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-database-functions">Database functions</see>, and
    ///     <see href="https://aka.ms/efcore-docs-LibSql">Accessing LibSql databases with EF Core</see> for more information and examples.
    ...
    /// <summary>
    ///     Maps to the LibSql <c>unhex</c> function which returns a BLOB representing decoding of the hexadecimal string.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-database-functions">Database functions</see>, and
    ///     <see href="https://aka.ms/efcore-docs-LibSql">Accessing LibSql databases with EF Core</see> for more information and examples.
    ...
    /// <summary>
    ///     Maps to the LibSql <c>substr</c> function which returns a subarray of the specified value. The subarray starts
    ...
    /// <summary>
    ///     Maps to the LibSql substr function which returns a subarray of the specified value. The subarray starts
