...
/// <summary>
///     LibSql specific extension methods for <see cref="IReadOnlyEntityTypeMappingFragment" />.
/// </summary>
public static class LibSqlEntityTypeMappingFragmentExtensions
{
    ...
    public static void UseSqlReturningClause(this IMutableEntityTypeMappingFragment fragment, bool? useSqlReturningClause)
        => fragment.SetAnnotation(LibSqlAnnotationNames.UseSqlReturningClause, useSqlReturningClause);
    ...
    public static bool? UseSqlReturningClause(
        ...
        => (bool?)fragment.SetAnnotation(LibSqlAnnotationNames.UseSqlReturningClause, useSqlReturningClause, fromDataAnnotation)?.Value;
