...
{
    private readonly bool _isReturningClauseSupported=true;
    ...
    public override ResultSetMapping AppendInsertOperation(
        ...
        // However, older LibSql versions and virtual tables don't support RETURNING, so we do INSERT+SELECT.
    ...
    public override ResultSetMapping AppendUpdateOperation(
        ...
        // However, older LibSql versions and virtual tables don't support RETURNING, so we do UPDATE+SELECT.
        => CanUseReturningClause(command)
    ...
    public override ResultSetMapping AppendDeleteOperation(
        ...
        // However, older LibSql versions and virtual tables don't support RETURNING, so we do DELETE+SELECT.
        => CanUseReturningClause(command)
